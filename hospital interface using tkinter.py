...
con=sqlcon.connect(host="localhost",user="root",password="yashu123")#connection to mysql 
cur=con.cursor()
...
def lst_doc():
    ...
    l=["Dr. Sharma","Dr. Verma","Dr. Kumar","Dr. Khan","Dr. Kelly","Dr. Cho","Dr. Potter","Dr. White","Dr. Huber","Dr. Leo",'Dr. Thortein','Dr. Sins',
       'Dr. Salvatore','Dr. Haddock']
    m=["Orthopaedic surgeon","Orthopaedic surgeon","Dentist","Nephrologist","Dermatologist","Gynaecologist","Physician","Physician","ENT Specialist",
       "Neurologist",'Cardiologist','Pediatrician','X-ray','Plastic Surgeon']
...
root=Tk()
label=Label(root,text="LEISING CARE HOSPITAL",font="arial 40 bold",bg='light blue')
